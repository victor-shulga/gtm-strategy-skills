...
argument-hint: "(reads stage + buyer journey + ICP/VP/offers from steps 2-8 in Notion)"
---

# 09 · Materials / Content Plan (scored)

Дев'ятий крок. Спланувати **матеріали/контент** як **scored inventory, прив'язаний до buyer journey**
(08). НЕ генеруємо самі ассети — даємо inventory + gap + пріоритети (рішення з архітектури). Без гейту.

Вхід — 02 (стадія), 08 (шлях клієнта + контент-на-стадію), 03/05/06/07 (для «how to create»). Прочитай
...
- *Material* · *Maps-to-stage* (journey) · *Status* (To-Do / In progress / Done) ·
  **Quality Score (0 / 1 / 2)** · *Priority* · **How-to-create** (фреймворк/крок: ICP(03) · Value
  Prop canvas(06) · Messaging · Buyer journey(08) · Customer interview · Competitor(05) · Offer(07)).
...
## Вихід (Notion)
Під-сторінка **«09 · Materials Plan»**: (1) контент×стадія · (2) scored inventory + **Readiness %** ·
(3) interface breakdown · (4) gap/overshoot/undershoot + 3-5 дій · «Джерела / припущення». Українською.

## Definition of Done
- Контент змаплено на стадії journey (08).
